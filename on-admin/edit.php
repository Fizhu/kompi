...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Data users &raquo; Edit Data</h2>
			<hr />
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE users SET nama='$nama', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', alamat='$alamat', no_telepon='$no_telepon', jabatan='$jabatan', status='$status' WHERE id_user='$id_user'") or die(mysqli_error());
				if($update){
					header("Location: edit.php?id_user=".$id_user."&pesan=sukses");
				}else{
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="id_user" value="<?php echo $row ['id_user']; ?>" class="form-control" placeholder="id_user" required>
					</div>
				</div>
				<div class="form-group">
